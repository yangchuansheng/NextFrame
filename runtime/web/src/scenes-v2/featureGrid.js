...
export default {
  ...
  params: {
    ...
    titleSize:   { type: "number", default: 0.035, desc: "Title font size (ratio or px or keyword)", min: 0.015, max: 0.08 },
    descSize:    { type: "number", default: 0.022, desc: "Desc font size (ratio or px or keyword)", min: 0.01, max: 0.05 },
