...
describe("BDD critical scenarios", () => {
  ...
  it("INS-02 SCENE_MANIFEST exposes 17 scenes with parameter schemas", () => {
    expect(SCENE_MANIFEST.length).toBe(17, "Expected the built-in scene manifest to list seventeen built-in scenes");
    expect(
