...
const REQUIRED_SUBCOMMANDS = ["new", "validate", "frame", "render", "bake-html", "bake-video", "bake-browser", "describe", "gantt", "scenes", "add-clip", "move-clip", "resize-clip", "remove-clip", "set-param"];
