...
export const RENDER_FNS = { auroraGradient, barChartReveal, circleRipple, cornerBadge, countdown, dataPulse, fluidBackground, glitchText, htmlSlide, imageHero, kineticHeadline, lineChart, lowerThirdVelvet, meshGrid, neonGrid, orbitRings, particleFlow, pixelRain, shapeBurst, spotlightSweep, starfield, textOverlay, vignette, ccFrame, ccBigNumber, ccPill, ccNote, ccDesc };
